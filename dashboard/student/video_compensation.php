...
if (basename(__FILE__) === basename($_SERVER['SCRIPT_FILENAME'])) {
  echo '<script>
    window.location.href = "/student-portal/dashboard/student/index.php?page=video_compensation";
  </script>';
  exit;
}
...
if (!$stmt->fetch()) {
  ...
  echo '<script>window.location.href = "/student-portal/dashboard/student/index.php";</script>';
  exit;
}
$stmt->close();
