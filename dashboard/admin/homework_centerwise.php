<?php
// dashboard/admin/homework_centerwise.php
...
<div class="max-w-5xl mx-auto p-6 space-y-6">
  ...
  <form method="get" class="grid grid-cols-1 md:grid-cols-4 gap-4">
    ...
    <div>
      ...
      <select name="centre"
              class="w-full border-gray-300 rounded focus:ring focus:border-admin-primary">
    ...
    <div class="flex items-end">
      <button type="submit"
              class="w-full px-4 py-2 bg-admin-primary text-white rounded-lg
